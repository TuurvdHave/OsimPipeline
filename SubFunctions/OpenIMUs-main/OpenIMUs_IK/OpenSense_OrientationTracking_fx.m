function [] = OpenSense_OrientationTracking_fx(modelFileName, orientationsFileName, startTime, endTime, resultsDirectory, visualizeTracking, IK_xml, OpenSense_folder)
