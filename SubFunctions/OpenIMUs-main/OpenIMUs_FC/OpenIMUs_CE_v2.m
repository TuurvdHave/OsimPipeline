...
model = Model([path_input,'\' Subject '.osim' ]); 
...
%Knee R
kR = model.updJointSet().get('walker_knee_r');
...
%KneeL
kL = model.updJointSet().get('walker_knee_l');
...
%%
pelvis_tilt = Coord.pelvis.tilt;
pelvis_list = Coord.pelvis.list;
lumbar_extension = Coord.lumbar.extension;
lumbar_bending = Coord.lumbar.bending;
lumbar_rotation = Coord.lumbar.rotation;
hip_flexion_r = Coord.hip_r.flexion;
hip_adduction_r = Coord.hip_r.adduction;
hip_rotation_r = Coord.hip_r.rotation;
hip_flexion_l = Coord.hip_l.flexion;
hip_adduction_l = Coord.hip_l.adduction;
hip_rotation_l = Coord.hip_l.rotation;
knee_angle_r = Coord.knee_r.angle;
knee_angle_l = Coord.knee_l.angle;
ankle_angle_r = Coord.ankle_r.angle;
ankle_angle_l = Coord.ankle_l.angle;
subtalar_angle_r = Coord.subtalar_r.angle;
subtalar_angle_l = Coord.subtalar_l.angle;
...
if coord_estimation
    ...
    q_Rtibr = quaternion([0, -Coord_Est.knee_r.angle, 0],'euler','XZY','frame');% OpenSim offset
    q_Rtibl = quaternion([0, -Coord_Est.knee_l.angle, 0],'euler','XZY','frame');% OpenSim offset
...
%     q_Rfeml = quaternion([Coord.hip_l.adduction*0.5, Coord.hip_l.flexion*0.5, Coord.hip_l.rotation*0.5],'euler','XZY','frame');% OpenSim offset
    ...
    q_Rtibr = quaternion([0, Coord.knee_r.angle, 0],'euler','XZY','frame');% OpenSim offset
    q_Rtibl = quaternion([0, Coord.knee_l.angle, 0],'euler','XZY','frame');% OpenSim offset
