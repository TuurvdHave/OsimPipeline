...
q_rotations  = zeros(12,4,5);% 5 walking / 12 joints
q_calibration  = zeros(12,4,5);% 5 walking / 12 joints
alignment_angles = zeros(4,5);% 4 angle / 5 walking
n=5; % 1st walking trial -1
%% PIPELINE CALIBRATION P3
tic
for j = 6:10
...
qLT = quaternion([0 0 0], 'eulerd', 'XYZ', 'frame');% left tibia
qRT = quaternion([0 0 0], 'eulerd', 'XYZ', 'frame');% right tibia
...
qLC = quaternion([0 0 0], 'eulerd', 'XYZ', 'frame');% left toes
qRC = quaternion([0 0 0], 'eulerd', 'XYZ', 'frame');% right toes
