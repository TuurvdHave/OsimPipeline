...
for i =1
    N_var_q = (length(fieldnames(rawData.sensors))-3) *4 + 1; %quaternions %no head, no sholders r and l
N_var = (length(fieldnames(rawData.sensors))-3) *3 + 1;% acc/gyr/magt
start_line = 7;
...
opts.VariableNames = ["time", 'torso_imuX', 'torso_imuY', 'torso_imuZ',...
    ...
    'hand_l_imuX', 'hand_l_imuY', 'hand_l_imuZ',...
    'hand_r_imuX', 'hand_r_imuY', 'hand_r_imuZ',...
    ];
...
opts.VariableNames = ["time", 'torso_imu_q0', 'torso_imu_q1', 'torso_imu_q2', 'torso_imu_q3',...
    ...
    'hand_l_imu_q0', 'hand_l_imu_q1', 'hand_l_imu_q2', 'hand_l_imu_q3',...
    'hand_r_imu_q0', 'hand_r_imu_q1', 'hand_r_imu_q2', 'hand_r_imu_q3'];
