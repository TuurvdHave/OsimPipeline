...
int main() {
    ...
    OpenSim::STOFileAdapter motfileadapter{};
	...
	//SimTK::Quaternion myQuad;
	// Pre allocate matrix with quaternions
	// SimTK::Matrix_<SimTK::Quaternion> rotationsData{1024,8};

	// TimeSeriesTableQuaternion::RowVector
		// orientation_row_vector{ n_imus, SimTK::Quaternion() };

	OpenSim::TimeSeriesTableVec3::RowVector
		accel_row_vector{ 8, SimTK::Vec3(SimTK::NaN) };
